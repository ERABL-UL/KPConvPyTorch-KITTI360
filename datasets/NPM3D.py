...
class NPM3DDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True):
        ...
        self.label_to_names = {0: 'unlabeled',
                               ...
                               3: 'out of roi',       # pole - road sign - traffic light
                               4: 'static',    # bollard - small pole
                               5: 'dynamic',      # trash can
                               6: 'ground',
                               7: 'road',
                               8: 'sidewalk',
                               ...
                               10: 'rail track',
                               11: 'building',
                               12: 'wall',       # pole - road sign - traffic light
                               13: 'fence',    # bollard - small pole
                               14: 'guard rail',      # trash can
                               15: 'bridge',
                               16: 'tunnel',
                               17: 'pole',
                               18: 'polegroup',
                               19: 'traffic light',
                               20: 'traffic sign',
                               21: 'vegetation',       # pole - road sign - traffic light
                               22: 'terrain',    # bollard - small pole
                               23: 'sky',      # trash can
                               24: 'person',
                               25: 'rider',
                               26: 'car',
                               ...
                               28: 'bus',
                               29: 'caravan',
                               30: 'trailer',       # pole - road sign - traffic light
                               31: 'train',    # bollard - small pole
                               32: 'motorcycle',      # trash can
                               33: 'bicycle',
                               34: 'garage',
                               35: 'gate',
                               36: 'stop',
                               37: 'smallpole',
                               38: 'lamp',
                               39: 'trash bin',       # pole - road sign - traffic light
                               40: 'vending machine',    # bollard - small pole
                               41: 'box',      # trash can
        ...
        # Dataset folder
        self.path = '/home/reza/Desktop/WILL/kitti360/files/'
        ...
        self.train_path = 'normalized'
        self.original_ply_path = 'plyfiles'
        ...
        self.files = []
        if self.set == 'training':
            trainfiles = open(join(self.path ,'train.txt'), 'r')
            self.files = trainfiles.readlines()
        elif self.set in ['validation', 'ERF']:
            validfiles = open(join(self.path ,'validation.txt'), 'r')
            self.files = validfiles.readlines()
        elif self.set == 'test':
            testfiles = open(join(self.path ,'test.txt'), 'r')
            self.files = testfiles.readlines()
        else:
            raise ValueError('Unknown set for NPM3D data: ', self.set)
        ...
        for i in range(len(self.files)):
            self.cloud_names += [os.path.basename(self.files[i])[:-5]]
